package ch.epfl.dias.cs422.helpers.rel.early.volcano

import ch.epfl.dias.cs422.helpers.rel.RelOperator
import ch.epfl.dias.cs422.helpers.rel.RelOperator.{Elem, Tuple}

trait Operator extends RelOperator with Iterable[Tuple] {
   ...
   */
  final override def iterator: Iterator[Tuple] = new Iterator[Tuple] with AutoCloseable {
    ...
    var n: Option[List[Elem]] = Option.empty
